...
raw = raw.replace('proof6-writer-runtime-r3f', 'proof6-writer-runtime-r3h').replace('FRESH_R3F','FRESH_R3H')
exec(compile(raw, 'test_r3f.py (R3h identity adapter)', 'exec'), original.__dict__)
