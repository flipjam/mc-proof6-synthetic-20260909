...
raw = raw.replace('proof6-writer-runtime-r3f', 'proof6-writer-runtime-r3i').replace('FRESH_R3F','FRESH_R3I')
exec(compile(raw, 'test_r3f.py (R3i identity adapter)', 'exec'), original.__dict__)
