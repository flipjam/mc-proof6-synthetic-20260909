...
PUBLIC = {'GITHUB_REPOSITORY':'flipjam/mc-proof6-synthetic-20260909',
    'GITHUB_REPOSITORY_ID':'1363510385', 'GITHUB_REF':'refs/heads/proof6-writer-runtime-r3h',
    'GITHUB_WORKFLOW_REF':'flipjam/mc-proof6-synthetic-20260909/.github/workflows/proof6-writer.yml@refs/heads/proof6-writer-runtime-r3h',
...
class Native(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.temp=Path(tempfile.mkdtemp(prefix='proof6-r3h-offline-'))
    ...
    def tearDown(self):
        ...
        for path in (self.root,self.temp):
            ...
            self.assertTrue(path.name.startswith(('proof6-d04-signal-','proof6-r3h-offline-')))
            shutil.rmtree(path)
