...
raw = raw.replace('proof6-operation-journal-r3e', 'proof6-operation-journal-r3j')
raw = raw.replace('proof6-writer-runtime-r3e', 'proof6-writer-runtime-r3j')
raw = raw.replace("'r3e'", "'r3j'")
raw = raw.replace('34b940e0537f57e5fa225768a55214bd3d3c5340',
                  '04441e984236d17664c1200868d8cd3ade1dfb81')
...
# A no-journal launcher mock has no diagnostic snapshot.
raw = raw.replace('fake=Mock();fake.commit_transition', 'fake=Mock(_journal_confirmation=None);fake.commit_transition')
