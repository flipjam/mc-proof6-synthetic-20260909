...
def identity(raw):
    return raw.replace(b'r3h',b'r3j').replace(b'R3H',b'R3J').replace(b'R3h',b'R3j').replace(
        b'd754156067cf1aa2318e7b04d7fcf47902eb9846',b'04441e984236d17664c1200868d8cd3ade1dfb81')
