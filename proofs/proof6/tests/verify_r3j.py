...
def verify():
    ...
    assert verify_scope()
    identity_only=('app_probes.py','d03_job_token.py','d04_capability.py','d04_prerequisite.py','d04_signal.py')
    ...
    inventory.update(canonical_rows=72,fresh=72,inherited=0,NOT_APPLICABLE=0,
        ...
        canary_credit=0,R3j_provisioned=False,R3j_frozen=False,R3j_executed=False)
    return inventory
