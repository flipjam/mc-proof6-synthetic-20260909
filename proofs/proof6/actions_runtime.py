...
RUNTIME_REF = 'refs/heads/proof6-writer-runtime-r2d2'
...
def guard(manifest):
    ...
    rule = get(base + '/rulesets/22730525')
    ...
    _require(policy['id'] == 59579447 and policy['name'] == 'proof6-writer-runtime-r2d2'
...
def reconcile_prior_runs(manifest):
    ...
    while True:
        ...
        prior.extend(run for run in runs['workflow_runs']
                     ...
                     and run['head_branch'] == 'proof6-writer-runtime-r2d2'
