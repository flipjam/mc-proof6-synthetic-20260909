...
RUNTIME_REF = 'refs/heads/proof6-writer-runtime-r2d3'
...
def get(path):
    request = urllib.request.Request('https://api.github.com/' + path, headers={
        ...
        'Accept': 'application/vnd.github+json', 'User-Agent': 'proof6-runtime-r2d3'})
...
def guard(manifest):
    ...
    rule = get(base + '/rulesets/22732848')
    ...
    _require(policy['id'] == 59579447 and policy['name'] == 'proof6-writer-runtime-r2d3'
...
def reconcile_prior_runs(manifest):
    ...
    while True:
        ...
        prior.extend(run for run in runs['workflow_runs']
                     ...
                     and run['head_branch'] == 'proof6-writer-runtime-r2d3'
