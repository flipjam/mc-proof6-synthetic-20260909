...
RUNTIME_REF = 'refs/heads/proof6-writer-runtime-simplified'
...
def guard(manifest):
    ...
    rule = get(base + '/rulesets/22736206')
    ...
    _require(policy['id'] == 59579447 and policy['name'] == 'proof6-writer-runtime-simplified'
